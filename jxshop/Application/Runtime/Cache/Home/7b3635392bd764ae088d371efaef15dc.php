			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="/<?php echo ($pic["0"]["goods_img"]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/<?php echo ($pic["0"]["goods_img"]); ?>" alt="" width="350px" height="350px"/>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?php echo (date('Y-m-d',$goods_addtime)); ?></li>
				...
				<div class="detail_bd">
					...
					<div class="comment_summary">
						...
						<?php if(!empty($_SESSION['user_id'])): ?><div class="comment_form mt20">
							<form action="<?php echo U('Goods/comment');?>" method="post">
								<ul>
									<li>
										<label for=""> 评分：</label>
...
<!-- 底部版权 end -->
	...
	<script type="text/javascript">
		...
		$('.useful').click(function (){
			...
			$.post("<?php echo U('Goods/goodNumber');?>",{comment_id:comment_id},function (data) {
				obj.html(data.good_number);
			});
		})
	</script>
</body>
