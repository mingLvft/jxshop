    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($data["data"])): $i = 0; $__LIST__ = $data["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center">
                <a href="/Admin/Goods/setNumber/goods_id/<?php echo ($vo["id"]); ?>" target="_blank" title="库存设置">库存设置</a>
                <a href="/Admin/Goods/edit/goods_id/<?php echo ($vo["id"]); ?>" title="编辑"><img src="/Public/Admin/Images/icon_edit.gif" width="16" height="16" border="0" /></a>
                <a href="/Admin/Goods/dels/goods_id/<?php echo ($vo["id"]); ?>" onclick="" title="回收站"><img src="/Public/Admin/Images/icon_trash.gif" width="16" height="16" border="0" /></a></td>
