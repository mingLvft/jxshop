            ...
            <form enctype="multipart/form-data" action="" method="post">
                <table width="90%" class="table" align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            促销价格：<input type="text" name="cx_price"  value="<?php echo ($info["cx_price"]); ?>" size="30" />
                            开始时间：<input type="text" name="start" <?php if(($info["start"]) != "{0"): ?>value="<?php echo ($info["start"]); ?>"<?php endif; ?>>
                            结束时间：<input type="text" name="end" <?php if(($info["end"]) != "{0"): ?>value="<?php echo ($info["end"]); ?>"<?php endif; ?>>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="button" name="addExCate" id="addExCate" value="增加扩展分类">
                    ...
                    <tr>
                        ...
                        <td>
                            <script id="editor" name="goods_body" type="text/plain" style="width:500px;height:300px;"><?php echo ($info["goods_body"]); ?></script>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td colspan="2" id="showAttr">
                            <table width="90%" align="center" >
                                <?php if(is_array($attr_list)): $i = 0; $__LIST__ = $attr_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if(is_array($v)): $i = 0; $__LIST__ = $v;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <table width="90%"class="table pic" align="center" style="display: none">
                    <tr>
                        <td colspan="2">
                            <?php if(is_array($goods_img_list)): $i = 0; $__LIST__ = $goods_img_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="width: 100px; float: left; height: 100px; margin: 0px 10px">
                                <img src="/<?php echo ($vo["goods_thumb"]); ?>" alt="">
...
<script type="text/javascript" charset="utf-8" src="/Public/Admin/Js/jquery-1.8.3.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        $('.delimg').click(function () {
            ...
            //获取点击删除按钮对应的div对象
            var obj = $(this).parent();
           $.post("<?php echo U('Goods/delImg');?>",{img_id:img_id},function (data) {
               if(data.status == 1){
                    //删除图片成功
                    obj.remove();
                }
