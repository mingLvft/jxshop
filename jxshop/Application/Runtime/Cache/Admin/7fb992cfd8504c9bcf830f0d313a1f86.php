    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center" class="first-cell"><span><?php echo ($vo["type_id"]); ?></span></td>
                <td align="center" class="first-cell"><span><?php if(($vo["attr_type"]) == "1"): ?>唯一属性<?php else: ?>单选属性<?php endif; ?></span></td>
                <td align="center" class="first-cell"><span><?php if(($vo["attr_input_type"]) == "1"): ?>手工输入<?php else: ?>列表选项<?php endif; ?></span></td>
                <td align="center" ><span><?php echo ($vo["attr_value"]); ?></span></td>
                <td align="center">
                <a href="<?php echo U('edit','attr_id='.$vo['id']);?>" title="编辑">编辑</a>
                <a href="/Admin/Attribute/dels/attr_id/<?php echo ($vo["id"]); ?>" onclick="" title="回收站">删除</a></td>
