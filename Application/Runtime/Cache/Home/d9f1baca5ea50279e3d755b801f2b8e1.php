		...
		<table>
			...
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td class="col4"> 
						...
						<a href="javascript:;" class="add_num" data-goods-id="<?php echo ($vo["goods_id"]); ?>" data-goods-attr-ids="<?php echo ($vo["goods_attr_ids"]); ?>"></a>
					</td>
					<td class="col5">￥<span><?php echo ($vo['goods_count']*$vo['goods']['shop_price']); ?></span></td>
					<td class="col6"><a href="<?php echo U('Cart/dels','goods_id='.$vo['goods_id'].'&goods_attr_ids='.$vo['goods_attr_ids']);?>">删除</a></td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			</tbody>
			<tfoot>
				<tr>
					<td colspan="6">购物金额总计： <strong>￥ <span id="total"><?php echo ($total["price"]); ?></span></strong></td>
				</tr>
			</tfoot>
		</table>
...
<script>
	...
	function updateCount(goods_id,goods_attr_ids,goods_count) {
		$.post("<?php echo U('Cart/updateCount');?>",{goods_id:goods_id,goods_attr_ids:goods_attr_ids,goods_count:goods_count},function () {
