...
<div class="header w1210 bc mt15">
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl <?php if(empty($is_show)): ?>cat1<?php endif; ?>"> <!-- 非首页，需要添加cat1类 -->
            <div class="cat_hd off <?php if(empty($is_show)): ?>off<?php endif; ?>">  <!-- 注意，首页在此div上只需要添加cat_hd类，非首页，默认收缩分类时添加上off类，鼠标滑过时展开菜单则将off类换成on类 -->
                <h2>全部商品分类</h2>
                <em></em>
            </div>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<dl>
						...
						<?php if(is_array($data["price"])): $i = 0; $__LIST__ = $data["price"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd <?php if(($_GET['price']) == $vo): ?>class="cur"<?php endif; ?>><a href="<?php echo myU('price',$vo);?>"><?php echo ($vo); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
					</dl>

					<?php if(is_array($data["attrwhere"])): $i = 0; $__LIST__ = $data["attrwhere"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
						<dt><?php echo ($vo["0"]["attr_name"]); ?>：</dt>
						<?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dd><a href="<?php echo myU('attr',$v['attr_values']);?>"><?php echo ($v["attr_values"]); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
			...
			<div class="sort mt10">
				<dl>
					<dt>排序：</dt>
					<dd <?php if(($_GET['sort']== sale_number) OR ($_GET['sort']== null)): ?>class="cur"<?php endif; ?>><a href="<?php echo myU('sort','sale_number');?>">销量</a></dd>
				...
				<ul>
					<?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<dl>
							...
							<dd><a href=""><em>已有<?php echo ($vo["plcount"]); ?>人评价</em></a></dt>
						</dl>
