...
<div style="clear:both;"></div>
	...
	<?php if(is_array($floor)): $i = 0; $__LIST__ = $floor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--1F 电脑办公 start -->
		...
		<div class="floor_left fl">
			...
			<div class="goodslist fl">
				...
				<div class="goodslist_wrap">
					<?php if(is_array($vo["recson"])): $keys = 0; $__LIST__ = $vo["recson"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($keys % 2 );++$keys;?><div>
						<ul>
